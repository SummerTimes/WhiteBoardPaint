...
import static com.kk.drawing.utils.PaintConstants.COLOR1;
import static com.kk.drawing.utils.PaintConstants.COLOR2;
import static com.kk.drawing.utils.PaintConstants.COLOR3;
import static com.kk.drawing.utils.PaintConstants.COLOR4;
import static com.kk.drawing.utils.PaintConstants.COLOR5;
import static com.kk.drawing.utils.PaintConstants.COLOR6;
import static com.kk.drawing.utils.PaintConstants.COLOR7;
import static com.kk.drawing.utils.PaintConstants.COLOR8;
import static com.kk.drawing.utils.PaintConstants.COLOR_VIEW_SIZE;
import static com.kk.drawing.utils.PaintConstants.LOAD_ACTIVITY;
...
import com.kk.drawing.interfaces.PaintViewCallBack;
import com.kk.drawing.utils.BitMapUtils;
import com.kk.drawing.utils.ImageButtonTools;
import com.kk.drawing.utils.PaintConstants.ERASER_SIZE;
import com.kk.drawing.utils.PaintConstants.PEN_SIZE;
import com.kk.drawing.utils.PaintConstants.PEN_TYPE;
import com.kk.drawing.utils.PaintConstants.SHAP;
import com.kk.drawing.view.ColorPickerDialog;
import com.kk.drawing.view.ColorPickerDialog.OnColorChangedListener;
import com.kk.drawing.view.ColorView;
import com.kk.drawing.view.OkCancleDialog;
import com.kk.drawing.view.OkDialog;
import com.kk.drawing.view.PaintView;
import com.kk.drawing.view.SaveDialog;
...
public class Main extends Activity implements OnClickListener {
	...
	private void initLayout() {
		...
		eraserSizeLayout.setBackgroundDrawable(getResources().getDrawable(R.drawable.popbackground4));
		penSizeLayout.setBackgroundDrawable(getResources().getDrawable(R.drawable.popbackground4));
	...
	private void setBackGroundDrawable() {
		clearButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.newfile));
		eraserButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.eraser));
		loadButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.loadpicture));
		saveButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.save));
		penSizeButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.pen_default));
		colorSelectButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.colorselect));
		redoButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.cantredo));
		undoButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.cantundo));
		toButtonLayoutButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.changetobuttonlayout));
		toColorLayoutButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.changetocolorlayout));
		toolButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.tools));
	}
	...
	private void initColorRadioGroup() {
		...
		LayoutParams params = new LayoutParams(COLOR_VIEW_SIZE, COLOR_VIEW_SIZE);
		...
		for (ColorView colorView : mColorViewList) {
			...
			colorView.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
					for (ColorView colorView : mColorViewList) {
						if (buttonView.equals(colorView) && buttonView.isChecked()) {
							setToLastPenTeype();
	...
	private void initShapRadioGroupf() {
		shapRadioGroupf.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
	...
	private void initShapRadioGroup() {
		...
		shapRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
	...
	private void initPenSizeGroup() {
		...
		penSizeRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
	...
	private void initEraseSizeGroup() {
		...
		eraserSizeRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
	...
	private View initToolPopWindowLayout() {
		...
		toolsPopupWindow = new PopupWindow(toolsPopup, LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT, true);
	...
	private void initToolPopButtons(View toolsPopup) {
		plainPaintButton = (Button) toolsPopup.findViewById(R.id.buttonPlainPen);
		...
		backGroundColorButton = (Button) toolsPopup.findViewById(R.id.buttonSelectBackGroundColor);
	...
	private View initPopLayout() {
		LayoutInflater mLayoutInflater = (LayoutInflater) this.getSystemService(LAYOUT_INFLATER_SERVICE);
		View menuPopup = mLayoutInflater.inflate(R.layout.translucent_button, null);
		mPopupWindow = new PopupWindow(menuPopup, LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT, true);
	...
	private void initMenuPopButtons(View menuPopup) {
		...
		exitButton.setImageDrawable(getResources().getDrawable(R.drawable.quit));
		exitButton.setOnClickListener(this);

		aboutButton = (ImageButton) menuPopup.findViewById(R.id.aboutButton);
		aboutButton.setImageDrawable(getResources().getDrawable(R.drawable.about));
		aboutButton.setOnClickListener(this);

		helpButton = (ImageButton) menuPopup.findViewById(R.id.helpButton);
		helpButton.setImageDrawable(getResources().getDrawable(R.drawable.help));
	...
	private void onClickButtonTools() {
		setAllLayoutInvisable();
		toolsPopupWindow.showAtLocation(findViewById(R.id.mainLayout), Gravity.RIGHT | Gravity.BOTTOM, 0, 0);
	}
	...
	public boolean onKeyUp(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_MENU) {
			setAllLayoutInvisable();
			mPopupWindow.showAtLocation(findViewById(R.id.mainLayout), Gravity.RIGHT | Gravity.BOTTOM, 0, 0);
		}
		// �������
	...
	private void enableRedoButton() {
		redoButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.redo));
	}
	...
	private void clearDialog() {
		OkCancleDialog dialog = new OkCancleDialog(this, new OnClickOkListener() {
	...
	private String getDirPath() {
		...
		System.out.println("�ļ�Ŀ¼��" + sdcarddir);
		String dirString = sdcarddir.getPath() + "/WhiteBoard/";
